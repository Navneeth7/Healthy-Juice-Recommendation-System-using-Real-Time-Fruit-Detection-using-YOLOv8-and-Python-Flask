...
model = YOLO("C:/Users/akroc/Downloads/mithun/Fruit_Detection-YOLOV8/runs/detect/train13/weights/best.pt")
...
def start_video_feed():
    ...
    if not video_feed_running:
        ...
        camera = cv2.VideoCapture(0)  # Change 0 to the appropriate camera index if needed
...
def plot_bboxes(image, boxes, labels=[], colors=[], score=True, conf=None):
  ...
  if labels == []:
    ...
    # labels = {0: u'apple', 1: u'banana',2: u'orange'} #
  #Define colors
  if colors == []:
...
def generate_frames():
    ...
    while True:
        ...
        if not success:
            ...
            plot_bboxes(frame, results[0].boxes.boxes, score=False, conf=0.85)
